          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="detailItem">
                ...
                <span className="itemValue">+1 3232 32 23</span>
              </div>
              <div className="detailItem">
