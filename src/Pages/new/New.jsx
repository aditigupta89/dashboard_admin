      ...
      <div className="right">
        ...
        <div className="formInput">
          ...
          {/* <div className="formInput">
            ...
            <input type="text" placeholder="johan doe"/>
          </div>
          <div className="formInput">
          ...
          <div className="formInput">
            <label>Email</label>
            <input type="email" placeholder="johan@gmail.com"/>
          </div>
          <div className="formInput">
           ...
           <div className="formInput">
            <label>Phone</label>
            <input type="text" placeholder="+1 2332 22 23"/>
          </div>
          <div className="formInput">
            <label>Address</label>
            <input type="text" placeholder="newyork elton st.234 yd"/>
